  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "prepare":
        if let args = call.arguments as? [String: Any] {
            ...
            let isStereo = args["isStereo"] as? Bool
            // echoCanceler and noiseSuppressor are Android specific or require more complex setup on iOS
            
            audioStreaming?.prepare(bitrate: bitrate, sampleRate: sampleRate, isStereo: isStereo)
        }
        result(nil)
